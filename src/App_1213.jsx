...
const site = {
  ...
  hero: {
    ...
    sub: "סרטון AI לבר מצווה ולבת מצווה בהתאמה אישית בר או בת מצווה זה רגע של פעם בחיים. הילד או הילדה במרכז הבמה – והסרט שמוקרן צריך להרגיש בדיוק ככה. אני יוצר סרטון AI לבר מצווה וסרטון AI לבת מצווה בהתאמה אישית, שמרגיש כמו קליפ אמיתי – לא מצגת תמונות. אם אתם מחפשים סרטון ai לבר מצווה בהתאמה אישית או סרטון ai לבת מצווה בהתאמה אישית שיפתח את האירוע ברמה אחרת – כאן זה קורה.תנו למסכים לרקוד יחד איתכם",
